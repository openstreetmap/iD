...
const wmfSitematrixCdnUrl =
    ENV__ID_WMF_SITEMATRIX_CDN_URL ||
...
if (
    ENV__ID_API_CONNECTION_URL !== null &&
...
const taginfoApiUrl =
    ENV__ID_TAGINFO_API_URL || 'https://taginfo.openstreetmap.org/api/4/';
const nominatimApiUrl =
    ENV__ID_NOMINATIM_API_URL || 'https://nominatim.openstreetmap.org/';
