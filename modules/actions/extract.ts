...
export function actionExtract(entityID: NodeId, projection: Projection): ActionExtract {
    ...
    function extractFromNode(node: osmNode, graph: coreGraph, shiftKeyPressed: boolean) {
