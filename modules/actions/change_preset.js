export function actionChangePreset(
    entityID,
    oldPreset,
    newPreset,
    skipFieldDefaults,
    ...
    return function action(graph) {
        ...
        if (newPreset) {
            ...
            if (newPreset.addTags) {
                preserveKeys = preserveKeys.concat(
                    Object.keys(newPreset.addTags),
                );
            }
            if (oldPreset && !oldPreset.id.startsWith(newPreset.id)) {
                ...
                newPreset
                    .fields(loc)
                    .concat(newPreset.moreFields(loc))
