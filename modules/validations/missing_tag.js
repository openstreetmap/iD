...
export function validationMissingTag(context) {
    ...
    function hasDescriptiveTags(entity) {
        ...
        var entityDescriptiveKeys = Object.keys(entity.tags).filter(
            function (k) {
    ...
    var validation = function checkMissingTag(entity, graph) {
        ...
        var isUnloadedNode =
            entity.type === 'node' && osm && !osm.isDataLoaded(entity.loc);
        ...
        var severity =
            canDelete && subtype !== 'highway_classification'
                ? 'error'
                : 'warning';
        ...
        return [
            new validationIssue({
                ...
                message: function (context) {
                    ...
                    return entity
                        ? t.append('issues.' + messageID + '.message', {
                ...
                dynamicFixes: function (context) {
                    ...
                    fixes.push(
                        new validationIssueFix({
                            icon: 'iD-icon-search',
                            title: t.append(
                                'issues.fix.' + selectFixType + '.title',
                            ),
