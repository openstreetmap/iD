...
export function validationIncompatibleSource() {
    ...
    const incompatibleRules = [
        ...
        },
        {
            ...
            regex: /google/i,
            exceptRegex:
                /((books|drive)\.google|google\s?(books|drive|plus))|(esri\/Google_Africa_Buildings)/i,
        },
    ];

    const validation = function checkIncompatibleSource(entity) {
        const entitySources =
            entity.tags && entity.tags.source && entity.tags.source.split(';');
            ...
            .map((source) => {
                ...
                return new validationIssue({
                    ...
                    message: (context) => {
                        ...
                        return entity
                            ? t.append(
                                  'issues.incompatible_source.feature.message',
                                  {
                    ...
                    dynamicFixes: () => {
                        return [
                            new validationIssueFix({
                                title: t.append(
                                    'issues.fix.remove_proprietary_data.title',
                                ),
                            }),
                        ];
                    },
        ...
        function getReference(id) {
            return function showReference(selection) {
                selection
                    ...
                    .call(
                        t.append(`issues.incompatible_source.reference.${id}`),
                    );
            };
        }
    };
