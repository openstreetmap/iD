...
export function validationUnsquareWay(context) {
    ...
    var validation = function checkUnsquareWay(entity, graph) {
        ...
        var degreeThreshold = isFinite(storedDegreeThreshold)
            ? Number(storedDegreeThreshold)
            : DEFAULT_DEG_THRESHOLD;
        ...
        if (!entity.tags.wikidata) {
            ...
            var autoAction = actionOrthogonalize(
                entity.id,
                context.projection,
                undefined,
                degreeThreshold,
        ...
        return [
            new validationIssue({
                ...
                message: function (context) {
                    ...
                    return entity
                        ? t.append('issues.unsquare_way.message', {
                        ...
                        new validationIssueFix({
                            ...
                            onClick: function (context, completionHandler) {
                                ...
                                context.perform(
                                    ...
                                    t(
                                        'operations.orthogonalize.annotation.feature',
                                        { n: 1 },
                                    ),
                                );
