...
import { osmEntity, osmUtil } from '../osm/index';
        ...
        fromJSON: function(json, loadChildNodes) {
            ...
            if (h.version === 2 || h.version === 3) {
                ...
                h.entities.forEach(function(entity) {
                    allEntities[osmUtil.key(entity)] = osmEntity(entity);
                });
