...
import type { osmWay, NodeId, WayId } from '../osm';
import type { CreateOperation, Operation } from '../core/history';


export const operationStraighten: CreateOperation = (context, selectedIDs) => {
    ...
    var _geometry: 'point' | 'line' | undefined;
    ...
    function chooseAction() {
        ...
        // straighten selected ways (possibly between range of 2 selected nodes)
            ...
            var startNodeIDs: NodeId[] = [];
            var endNodeIDs: NodeId[] = [];
