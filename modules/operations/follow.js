...
export function operationFollowReverse(selectedIDs, context) {

    var action = actionFollow(selectedIDs, context.projection, true);
    var nodes = utilGetAllNodes(selectedIDs, context.graph());
    var coords = nodes.map(function(n) { return n.loc; });
    ...
    operation.tooltip = function() {
        var disable = operation.disabled();
        return disable ?
            t('operations.follow_reverse.' + disable) :
            t('operations.follow_reverse.description.points');
    };


    operation.annotation = function() {
        return t('operations.follow_reverse.annotation.points');
    };


    operation.id = 'follow_reverse';
    operation.keys = [t('operations.follow_reverse.key')];
    operation.title = t('operations.follow_reverse.title');
    operation.behavior = behaviorOperation(context).which(operation);
