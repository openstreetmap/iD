...
export { entityEntity as Entity } from './entities/entity';
export { entityNode as Node } from './entities/node';
export { entityRelation as Relation } from './entities/relation';
export { entityWay as Way } from './entities/way';
