        ...
        paths = paths
            ...
            .each(function (entity) {
                ...
                if (layer === 'fill') {
                    this.setAttribute(
                        'clip-path',
                        'url(#ideditor-' + entity.id + '-clippath)',
                    );
                    this.style.fill = this.style.stroke = getPatternStyle(
                        entity.tags,
                    );
                }
            })
