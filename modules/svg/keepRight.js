...
export function svgKeepRight(projection, context, dispatch) {
    ...
    function markerPath(selection, klass) {
        selection
            ...
            .attr(
                'd',
                'M11.6,6.2H7.1l1.4-5.1C8.6,0.6,8.1,0,7.5,0H2.2C1.7,0,1.3,0.3,1.3,0.8L0,10.2c-0.1,0.6,0.4,1.1,0.9,1.1h4.6l-1.8,7.6C3.6,19.4,4.1,20,4.7,20c0.3,0,0.6-0.2,0.8-0.5l6.9-11.9C12.7,7,12.3,6.2,11.6,6.2z',
            );
    }
    ...
    function updateMarkers() {
        ...
        const markersEnter = markers
            ...
            .attr(
                'class',
                (d) =>
                    `qaItem ${d.service} itemId-${d.id} itemType-${d.parentIssueType}`,
            );
