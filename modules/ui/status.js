        ...
        function update(err, apiStatus) {
            ...
            if (err) {
                if (apiStatus === 'connectionSwitched') {
                    ...
                    selection
                        .html(t('osm_api_status.message.rateLimit'))
                        .append('a')
                    ...
                    selection
                        .html(t('osm_api_status.message.error') + ' ')
                        .append('a')
                        // let the user manually retry their connection directly
                        .html(t('osm_api_status.retry'))
                ...
                selection.html(t('osm_api_status.message.readonly'));
            } else if (apiStatus === 'offline') {
                selection.html(t('osm_api_status.message.offline'));
            }
