    ...
    function tasking(selection) {
        ...
        resizer.call(d3_drag()
            ...
            .on('drag', function() {
                ...
                var xMarginProperty = isRTL ? 'margin-left' : 'margin-right';
        ...
        tasking.hover = _throttle(hover, 200);


        tasking.intersects = function(extent) {
        ...
        tasking.select = function(id, newFeature) {
            tasking.hide();
            ...
            if (id) {
                ...
                if (selection.classed('collapsed')) {
                    if (newFeature) {
                        ...
                        tasking.expand(tasking.intersects(extent));
                    }
                }
                ...
                tasking.showPresetList = function() {
        ...
        tasking.show = function(component, element) {
            featureListWrap
                .classed('inspector-hidden', true);
            inspectorWrap
                .classed('inspector-hidden', true);
        ...
        tasking.expand = function(moveMap) {
            if (selection.classed('collapsed')) {
                tasking.toggle(moveMap);
            }
        };


        tasking.collapse = function(moveMap) {
            if (!selection.classed('collapsed')) {
                tasking.toggle(moveMap);
            }
        };
        ...
        tasking.toggle = function(moveMap) {
            var e = d3_event;
            if (e && e.sourceEvent) {
        ...
        resizer.on('dblclick', tasking.toggle);
    }

    tasking.showPresetList = function() {};
    tasking.hover = function() {};
    tasking.hover.cancel = function() {};
    tasking.intersects = function() {};
    tasking.select = function() {};
    tasking.show = function() {};
    tasking.hide = function() {};
    tasking.expand = function() {};
    tasking.collapse = function() {};
    tasking.toggle = function() {};
