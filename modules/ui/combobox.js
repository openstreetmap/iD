    ...
    var combobox = function (input, attachTo) {
            ...
            fetchComboData(value(), function (skipAutosuggest) {
                ...
                if (_suggestions.length) {
                    if (
                        doAutoComplete &&
                        !skipAutosuggest &&
                        input.property('selectionEnd') === val.length
                    ) {
        ...
        function nav(dir) {
            if (_suggestions.length) {
                ...
                // pick new _selected
                index = Math.max(
                    Math.min(index + dir, _suggestions.length - 1),
                    0,
                );
        ...
        function render() {
            ...
            combo
                ...
                .style(
                    'top',
                    rect.height + rect.top - containerRect.top + 'px',
                );
        }
