...
export function uiInfo(context) {
    ...
    function info(selection) {
        function redraw() {
            ...
            var containers = infoPanels
                .selectAll('.panel-container')
                .data(activeids, function (k) {
                    return k;
                });
            ...
            containers
                ...
                .style('opacity', 0)
                .on('end', function (d) {
                    d3_select(this).call(panels[d].off).remove();
                });

            var enter = containers
                .enter()
                .append('div')
            ...
            title.append('h3').each(function (d) {
                return panels[d].label(d3_select(this));
            });
        ...
        info.toggle = function (which) {
            ...
            if (which) {
                ...
                context
                    .container()
                    .select('.' + which + '-panel-toggle-item')
