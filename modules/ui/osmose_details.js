...
export function uiOsmoseDetails(context) {
    ...
    function osmoseDetails(selection) {
        ...
        if (issueString(_qaItem, 'detail')) {
            ...
            div.append('h4').call(t.append('QA.keepRight.detail_description'));
        ...
        if (issueString(_qaItem, 'fix')) {
            ...
            div.append('h4').call(t.append('QA.osmose.fix_title'));
        ...
        if (issueString(_qaItem, 'trap')) {
            ...
            div.append('h4').call(t.append('QA.osmose.trap_title'));
        ...
        services.osmose
            ...
            .then((d) => {
                ...
                if (
                    ...
                    context
                        .container()
                        .selectAll(`.qaItem.osmose.hover.itemId-${thisItem.id}`)
                        .empty()
                )
                    return;
                ...
                elemsDiv.append('h4').call(t.append('QA.osmose.elems_title'));
                ...
                elemsDiv
                    ...
                    .each(function () {
                        ...
                        if (entity) {
                            ...
                            if (!name) {
                                const preset = presetManager.match(
                                    entity,
                                    context.graph(),
                                );
                                name =
                                    preset &&
                                    !preset.isFallback() &&
                                    preset.name(); // fallback to preset name
                            }
