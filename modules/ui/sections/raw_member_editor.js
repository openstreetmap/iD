...
export function uiSectionRawMemberEditor(context) {
    ...
    function renderDisclosureContent(selection) {
        ...
        var itemsEnter = items
            ...
            .classed('member-incomplete', function (d) {
                return !d.member;
            });
        ...
        itemsEnter.each(function (d) {
            ...
            if (d.member) {
                ...
                labelLink
                    ...
                    .text(function (d) {
                        var matched = presetManager.match(
                            d.member,
                            context.graph(),
                        );
                        return (
                ...
                labelLink
                    ...
                    .classed(
                        'has-colour',
                        (d) =>
                            d.member.type === 'relation' &&
                            d.member.tags.colour &&
                            isColourValid(d.member.tags.colour),
                    )
                    .style(
                        'border-color',
                        (d) =>
