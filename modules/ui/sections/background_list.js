...
export function uiSectionBackgroundList(context) {
    ...
    var _settingsCustomBackground = uiSettingsCustomBackground(context).on(
        'change',
        customChanged,
    );
    ...
    function renderDisclosureContent(selection) {
        ...
        var bgExtrasListEnter = selection
            .selectAll('.bg-extras-list')
            .data([0])
            .enter()
            .append('ul')
            ...
            if (d.id === previousBackgroundID()) {
                ...
                item.call(
                    uiTooltip()
                        .placement(placement)
                        .title(() =>
                            hasDescription ? d.description() : d.label(),
                        ),
                );
            }
        });
