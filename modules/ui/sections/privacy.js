...
export function uiSectionPrivacy(context) {
    ...
    function renderDisclosureContent(selection) {
        // enter
        selection
            .selectAll('.privacy-options-list')
            .data([0])
            .enter()
            .append('ul')
            .attr('class', 'layer-list privacy-options-list');

        let thirdPartyIconsEnter = selection
            .select('.privacy-options-list')
            ...
            .call(
                uiTooltip()
                    .title(() =>
                        t.append(
                            'preferences.privacy.third_party_icons.tooltip',
                        ),
                    )
                    .placement('bottom'),
            );
        ...
        thirdPartyIconsEnter
            .append('span')
            .call(
                t.append('preferences.privacy.third_party_icons.description'),
            );
        ...
        selection
            ...
            .attr(
                'href',
                'https://github.com/openstreetmap/iD/blob/release/PRIVACY.md',
            )
            .append('span')
