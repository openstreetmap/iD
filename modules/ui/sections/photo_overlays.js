...
export function uiSectionPhotoOverlays(context) {
    ...
    function renderDisclosureContent(selection) {
        const container = selection.selectAll('.photo-overlay-container')
            .data([0]);
    ...
    function drawPhotoItems(selection) {
        ...
        const photoLayers = layers.all().filter(function(obj) { return photoKeys.indexOf(obj.id) !== -1; });
        const data = photoLayers.filter(function(obj) {
    ...
    function drawPhotoTypeItems(selection) {
        ...
        const li = ul.selectAll('.list-item-photo-types')
    ...
    function drawDateFilter(selection) {
        const data = context.photos().dateFilters();
    ...
    function drawUsernameFilter(selection) {
        ...
        const li = ul.selectAll('.list-item-username-filter')
        ...
        labelEnter
            ...
            .on('change', function() {
                const value = d3_select(this).property('value');
    ...
    function drawLocalPhotos(selection) {
        const photoLayer = layers.layer('local-photos');
        ...
        const localPhotosEnter = ulEnter
            .append('li')
            .attr('class', 'list-item-local-photos');

        const localPhotosLabelEnter = localPhotosEnter
            .append('label')
    ...
    function localPhotosChanged(d) {
        const localPhotosLayer = layers.layer('local-photos');
