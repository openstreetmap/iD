...
export function uiPaneHelp(context) {
    var docKeys = [
        ...
        ['streetlevel', ['intro', 'using_h', 'using', 'photos', 'viewer']],
        ['gps', ['intro', 'survey', 'using_h', 'using', 'tracing', 'upload']],
        ['qa', ['intro', 'tools_h', 'tools', 'issues_h', 'issues']],
    ];
    ...
    helpPane.renderContent = function (content) {
            ...
            function drawPrevious(selection) {
                if (i > 0) {
                    ...
                    prevLink
                        .call(
                            svgIcon(
                                rtl ? '#iD-icon-forward' : '#iD-icon-backward',
                                'inline',
                            ),
                        )
                        .append('span')
        ...
        shortcuts.append('div').call(t.append('shortcuts.title'));
