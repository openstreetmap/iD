...
export function uiKyObliqueViewer() {
  ...
  function setAngle(angle) {
    ...
    d3_select('.ky-oblique-wrapper').selectAll('.angle-button')
      .classed('active', function(d) { return d === _angle; });
  ...
  function updateImage() {
    ...
    fromUrl(url)
      ...
      .then(image => {
        ...
        return image.readRGB().then(rgb => {
          // readRGB returns a Uint8Array with 3 values per pixel (R, G, B).
          // Canvas ImageData needs 4 values per pixel (R, G, B, A).
