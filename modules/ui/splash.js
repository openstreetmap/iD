...
export function uiSplash(context) {
    return (selection) => {
        ...
        modalSection.append('p').html(
            t.html('splash.text', {
                version: context.version,
                website: {
                    html:
                        '<a target="_blank" href="https://github.com/openstreetmap/iD/blob/develop/CHANGELOG.md#whats-new">' +
                        t.html('splash.changelog') +
                        '</a>',
                },
                github: {
        ...
        modalSection.append('p').html(
            t.html('splash.privacy', {
                updateMessage: updateMessage,
                privacyLink: {
                    html:
                        '<a target="_blank" href="https://github.com/openstreetmap/iD/blob/release/PRIVACY.md">' +
