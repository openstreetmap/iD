...
export function uiIntroNavigation(context, reveal) {
    ...
    function dragMap() {
        ...
        timeout(function () {
            ...
            var textId =
                context.lastPointerType() === 'mouse' ? 'drag' : 'drag_touch';
            var dragString =
                helpHtml('intro.navigation.map_info') +
                '{br}' +
                helpHtml('intro.navigation.' + textId);
    ...
    function zoomMap() {
        ...
        var textId =
            context.lastPointerType() === 'mouse' ? 'zoom' : 'zoom_touch';
    ...
    function presetTownHall() {
        ...
        reveal(
            ...
            helpHtml('intro.navigation.preset_townhall', {
                preset: preset.name(),
            }),
            { buttonText: t.html('intro.ok'), buttonCallback: onClick },
        );
    ...
    function closeTownHall() {
        ...
        reveal(
            '.entity-editor-pane',
            helpHtml('intro.navigation.close_townhall', {
    ...
    function searchStreet() {
        ...
        timeout(function () {
            reveal(
                '.search-header input',
                helpHtml('intro.navigation.search_street', {
    ...
    function checkSearchResult() {
        var first = context
            .container()
            .select('.feature-list-item:nth-child(0n+2)'); // skip "No Results" item
    ...
    function selectedStreet() {
        if (
            !context.hasEntity(springStreetEndId) ||
    ...
    function editorStreet() {
        ...
        reveal(
            '.entity-editor-pane',
            helpHtml('intro.navigation.street_different_fields') +
                '{br}' +
    ...
    function play() {
        ...
        reveal(
            '.ideditor',
            helpHtml('intro.navigation.play', {
                next: t('intro.points.title'),
            }),
            {
