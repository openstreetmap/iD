...
export function uiIntroBuilding(context, reveal) {
    ...
    function startHouse() {
        ...
        timeout(function () {
            var startString =
                helpHtml('intro.buildings.start_building') +
                helpHtml(
                    'intro.buildings.building_corner_' +
    ...
    function continueHouse() {
        ...
        var continueString =
            helpHtml('intro.buildings.continue_building') +
            '{br}' +
            helpHtml(
    ...
    function chooseCategoryBuilding() {
        ...
        timeout(function () {
            ...
            var button = context
                .container()
                .select('.preset-category-building .preset-list-button');

            reveal(
                button.node(),
                helpHtml('intro.buildings.choose_category_building', {
    ...
    function choosePresetHouse() {
        ...
        timeout(function () {
            ...
            var button = context
                .container()
                .select('.preset-building-house .preset-list-button');

            reveal(
                button.node(),
                helpHtml('intro.buildings.choose_preset_house', {
    ...
    function closeEditorHouse() {
        ...
        timeout(function () {
            reveal(
                '.entity-editor-pane',
                helpHtml('intro.buildings.close', {
    ...
    function startTank() {
        ...
        timeout(function () {
            var startString =
                helpHtml('intro.buildings.start_tank') +
                helpHtml(
                    'intro.buildings.tank_edge_' +
                        (context.lastPointerType() === 'mouse'
                            ? 'click'
                            : 'tap'),
                );
    ...
    function continueTank() {
        ...
        var continueString =
            helpHtml('intro.buildings.continue_tank') +
            '{br}' +
            helpHtml(
                'intro.areas.finish_area_' +
                    (context.lastPointerType() === 'mouse' ? 'click' : 'tap'),
    ...
    function searchPresetTank() {
        ...
        timeout(function () {
            ...
            reveal(
                '.preset-search-input',
                helpHtml('intro.buildings.search_tank', {
        ...
        function checkPresetSearch() {
            ...
            if (first.classed('preset-man_made-storage_tank')) {
                reveal(
                    ...
                    helpHtml('intro.buildings.choose_tank', {
                        preset: tankPreset.name(),
                    }),
                    { duration: 300 },
                );
    ...
    function clickCircle() {
        ...
        context.history().on('change.intro', function () {
            ...
            timeout(function () {
                if (
                    context.history().undoAnnotation() ===
                    t('operations.circularize.annotation.feature', { n: 1 })
                ) {
                    continueTo(play);
                } else {
                    continueTo(retryClickCircle);
