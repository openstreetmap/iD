...
export function helpHtml(id, replacements) {
    ...
    if (!helpStringReplacements) {
        ...
        esc: localizer.t_html('shortcuts.key.esc'),
        space: localizer.t_html('shortcuts.key.space'),
        add_note_key: localizer.t_html('modes.add_note.key'),
        help_key: localizer.t_html('help.key'),
        shortcuts_key: localizer.t_html('shortcuts.toggle.key'),

        // reference localized UI labels directly so that they'll always match
        save: localizer.t_html('save.title'),
        undo: localizer.t_html('undo.title'),
        redo: localizer.t_html('redo.title'),
        upload: localizer.t_html('commit.save'),
        point: localizer.t_html('modes.add_point.title'),
        line: localizer.t_html('modes.add_line.title'),
        area: localizer.t_html('modes.add_area.title'),
        note: localizer.t_html('modes.add_note.label'),

        circularize: localizer.t_html('operations.circularize.title'),
        divide: localizer.t_html('operations.divide.title'),
        continue: localizer.t_html('operations.continue.title'),
        copy: localizer.t_html('operations.copy.title'),
        delete: localizer.t_html('operations.delete.title'),
        disconnect: localizer.t_html('operations.disconnect.title'),
        downgrade: localizer.t_html('operations.downgrade.title'),
        extract: localizer.t_html('operations.extract.title'),
        merge: localizer.t_html('operations.merge.title'),
        move: localizer.t_html('operations.move.title'),
        orthogonalize: localizer.t_html('operations.orthogonalize.title'),
        paste: localizer.t_html('operations.paste.title'),
        reflect_long: localizer.t_html('operations.reflect.title.long'),
        ...
        relations: localizer.t_html('inspector.relations'),
        new_relation: localizer.t_html('inspector.new_relation'),
        turn_restrictions: localizer.t_html('_tagging.presets.fields.restrictions.label'),
        background_settings: localizer.t_html('background.description'),
        imagery_offset: localizer.t_html('background.fix_misalignment'),
        start_the_walkthrough: localizer.t_html('splash.walkthrough'),
        help: localizer.t_html('help.title'),
        ok: localizer.t_html('intro.ok')
        };
    ...
    return localizer.t_html(id, reps)
