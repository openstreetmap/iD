...
export function helpHtml(id, replacements) {
    ...
    if (!helpStringReplacements) {
        helpStringReplacements = {
            ...
            // operation icons
            circularize_icon: icon(
                '#iD-operation-circularize',
                'inline operation',
            ),
            ...
            disconnect_icon: icon(
                '#iD-operation-disconnect',
                'inline operation',
            ),
            ...
            orthogonalize_icon: icon(
                '#iD-operation-orthogonalize',
                'inline operation',
            ),
            paste_icon: icon('#iD-operation-paste', 'inline operation'),
            reflect_long_icon: icon(
                '#iD-operation-reflect-long',
                'inline operation',
            ),
            reflect_short_icon: icon(
                '#iD-operation-reflect-short',
                'inline operation',
            ),
            ...
            straighten_icon: icon(
                '#iD-operation-straighten',
                'inline operation',
            ),
            ...
            mousewheel_icon: icon(
                '#iD-walkthrough-mousewheel',
                'inline operation',
            ),
            tap_icon: icon('#iD-walkthrough-tap', 'inline operation'),
            doubletap_icon: icon(
                '#iD-walkthrough-doubletap',
                'inline operation',
            ),
            longpress_icon: icon(
            ...
            turn_restrictions: t.html(
                '_tagging.presets.fields.restrictions.label',
            ),
...
export function selectMenuItem(context, operation) {
    return context
        .container()
        .select('.edit-menu .edit-menu-item-' + operation);
}
