...
export class osmWay extends OsmAbstractEntity {
  ...
  declare readonly nodes: NodeId[];
    ...
    /** @deprecated hack used for turn restictions */ declare __first?: boolean;
    /** @deprecated hack used for turn restictions */ declare __last?: boolean;
    /** @deprecated hack used for turn restictions */ declare __from?: boolean;
    /** @deprecated hack used for turn restictions */ declare __via?: boolean;
    /** @deprecated hack used for turn restictions */ declare __to?: boolean;
    /** @deprecated hack used for turn restictions */ declare __oneWay?: boolean;
