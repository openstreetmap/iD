...
export function presetField(fieldID, field, allFields) {
    ...
    _this.matchGeometry = (geom) =>
        !_this.geometry || _this.geometry.indexOf(geom) !== -1;
    ...
    _this.t = (scope, options) =>
        t(`_tagging.presets.fields.${fieldID}.${scope}`, options);
    _this.t.html = (scope, options) =>
        t.html(`_tagging.presets.fields.${fieldID}.${scope}`, options);
    _this.t.append = (scope, options) =>
        t.append(`_tagging.presets.fields.${fieldID}.${scope}`, options);
    _this.hasTextForStringId = (scope) =>
        localizer.hasTextForStringId(
    ...
    _this.label = () =>
        _this.overrideLabel
            ...
            : _this
                  ...
                  .t.append('label', { default: fieldID });

    _this.placeholder = () =>
        _this.resolveReference('placeholder').t('placeholder', { default: '' });
    ...
    _this.increment =
        _this.type === 'number' ? _this.increment || 1 : undefined;
