...
To inspect bundle size, run `npm run build:stats` — this builds with `--mode stats` and writes `docs/statistics.html`, which you can open in a browser.
...
The `iD.min.js` file in this project is autogenerated - don't edit it.
