describe('iD.validations.almost_junction', function () {
    ...
    function horizontalVertialFurtherThanThd() {
        ...
        var n3 = iD.osmNode({ id: 'n-3', loc: [22.4235, 0.001] });
        var n4 = iD.osmNode({ id: 'n-4', loc: [22.4235, -0.001] });
        var w2 = iD.osmWay({
            id: 'w-2',
            nodes: ['n-3', 'n-4'],
            tags: { highway: 'residential' },
    ...
    function closeEndNodesSmallAngle() {
        ...
        var n2 = iD.osmNode({ id: 'n-2', loc: [0.000306, 22.4432671] });
        var w1 = iD.osmWay({
            id: 'w-1',
            nodes: ['n-1', 'n-2'],
            tags: { highway: 'path' },
    ...
    function closeEndNodesBothSmallAngle() {
        ...
        var n1 = iD.osmNode({ id: 'n-1', loc: [0, 22.4427453] });
        var n2 = iD.osmNode({ id: 'n-2', loc: [0, 22.442981] });
        var n3 = iD.osmNode({ id: 'n-3', loc: [0.0000063, 22.442981] });
