describe('iD.operationStraighten', function () {
    ...
    describe('#available', function () {
        beforeEach(function () {
            ...
            graph = iD.coreGraph([
                iD.entityNode({ id: 'n1', type: 'node' }),
                iD.entityNode({ id: 'n2', type: 'node' }),
                iD.entityNode({ id: 'n2-1', type: 'node' }),
                iD.entityNode({ id: 'n3', type: 'node' }),
                iD.entityNode({ id: 'n4', type: 'node' }),
                iD.entityNode({ id: 'n5', type: 'node' }),
                iD.entityNode({ id: 'n6', type: 'node' }),
                iD.entityNode({ id: 'n7', type: 'node' }),
                iD.entityNode({ id: 'n8', type: 'node' }),
                iD.entityNode({ id: 'n9', type: 'node' }),
                iD.entityNode({ id: 'n10', type: 'node' }),
                iD.entityNode({ id: 'n11', type: 'node' }),
                iD.entityNode({ id: 'n12', type: 'node' }),
                iD.entityNode({ id: 'n13', type: 'node' }),
