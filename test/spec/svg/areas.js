describe('iD.svgAreas', function () {
    ...
    it('adds way and area classes', function () {
        ...
        _surface.call(
            iD.svgAreas(projection, context),
            graph,
            [graph.entity('w')],
            none,
        );
    ...
    describe('z-indexing', function () {
        ...
        it('stacks smaller areas above larger ones in a single render', function () {
            ...
            expect(
                _surface
                    .select('.area:nth-child(1)')
                    .classed('tag-landuse-park'),
            ).to.be.true;
            expect(
                _surface
                    .select('.area:nth-child(2)')
                    .classed('tag-building-yes'),
            ).to.be.true;
        });
