describe('iD.presetCollection', function () {
    ...
    describe('#item', function () {
        it('fetches a preset by id', function () {
            expect(c.item('__TEST/highway/residential')).to.equal(
                p.residential,
            );
        });
    });
    ...
    describe('#search', function () {
        ...
        it('includes the appropriate fallback preset', function () {
            expect(c.search('foo', 'point').collection, 'point').to.include(
                p.point,
            );
            expect(c.search('foo', 'line').collection, 'line').to.include(
                p.line,
            );
            expect(c.search('foo', 'area').collection, 'area').to.include(
                p.area,
            );
        });
        ...
        it('excludes presets with searchable: false', function () {
            ...
            expect(
                collection.search('excluded', 'point').collection,
