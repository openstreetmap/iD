...
describe('iD.serviceVegbilder', function () {
    ...
    describe('#init', function () {
        ...
        it('fetches available layers', function () {
            ...
            expect(availableLayers).to.not.have.key(
                ...
                features: [
                    {
                        ...
                        geometry: {
                            type: 'Point',
                            coordinates: [5.686, 58.901],
                        },
                        properties: {
                            BILDETYPE: 'Planar',
                            AAR: 2021,
                            TIDSPUNKT: '2021-05-05T06:42:47Z',
                            FYLKENUMMER: 11,
                            VEGKATEGORI: 'E',
                            VEGSTATUS: 'V',
                            VEGNUMMER: 39,
                ...
                features: [
                    {
                        ...
                        properties: {
                            BILDETYPE: 'Planar',
                            AAR: 2021,
                            TIDSPUNKT: '2021-01-01T11.11.11Z',
                            FYLKENUMMER: 1,
                            VEGKATEGORI: 'E',
                            VEGSTATUS: 'V',
                            VEGNUMMER: 1,
