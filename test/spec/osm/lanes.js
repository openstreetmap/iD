describe('iD.Lanes', function () {
    describe('default lane tags', function () {
        describe('motorway', function () {
            it('returns 2 lanes for highway=motorway', function () {
                expect(
                    iD.osmWay({ tags: { highway: 'motorway' } }).lanes()
                        .metadata.count,
                    'motorway lanes',
                ).to.eql(2);
                expect(
            ...
            it('returns 2 lanes for highway=motorway_link', function () {
                expect(
                    iD.osmWay({ tags: { highway: 'motorway_link' } }).lanes()
                        .metadata.count,
                    'motorway_link lanes',
                ).to.eql(2);
                expect(
        ...
        describe('trunk', function () {
            it('returns 4 lanes for highway=trunk', function () {
                expect(
                    iD.osmWay({ tags: { highway: 'trunk' } }).lanes().metadata
                        .count,
                    'trunk lanes',
                ).to.eql(4);
                expect(
                    iD
                        .osmWay({ tags: { highway: 'trunk', oneway: 'no' } })
                        .lanes().metadata.count,
                    'trunk lanes',
                ).to.eql(4);
            });
            ...
            it('returns 2 lanes for highway=trunk and oneway=yes', function () {
                expect(
                    iD
                        .osmWay({ tags: { highway: 'trunk', oneway: 'yes' } })
                        .lanes().metadata.count,
                    'trunk lanes',
                ).to.eql(2);
            });
            ...
            it('returns 2 lanes for highway=trunk_link', function () {
                expect(
                    iD.osmWay({ tags: { highway: 'trunk_link' } }).lanes()
                        .metadata.count,
                    'trunk_link lanes',
                ).to.eql(2);
                expect(
                    iD
                        .osmWay({
                            tags: { highway: 'trunk_link', oneway: 'no' },
                        })
                        .lanes().metadata.count,
                    'trunk_link lanes',
                ).to.eql(2);
            ...
            it('returns 1 lane for highway=trunk_link and oneway=yes', function () {
                expect(
                    iD
                        .osmWay({
                            tags: { highway: 'trunk_link', oneway: 'yes' },
                        })
                        .lanes().metadata.count,
                    'trunk_link lanes',
                ).to.eql(1);
        ...
        describe('primary', function () {
            it('returns 2 lanes for highway=primary', function () {
                expect(
                    iD.osmWay({ tags: { highway: 'primary' } }).lanes().metadata
                        .count,
                    'primary lanes',
                ).to.eql(2);
                expect(
                    iD
                        .osmWay({ tags: { highway: 'primary', oneway: 'no' } })
                        .lanes().metadata.count,
                    'primary lanes',
                ).to.eql(2);
            });
            ...
            it('returns 1 lane for highway=primary and oneway=yes', function () {
                expect(
                    iD
                        .osmWay({ tags: { highway: 'primary', oneway: 'yes' } })
                        .lanes().metadata.count,
                    'primary lanes',
                ).to.eql(1);
            });
            ...
            it('returns 2 lanes for highway=primary_link', function () {
                expect(
                    iD.osmWay({ tags: { highway: 'primary_link' } }).lanes()
                        .metadata.count,
                    'primary lanes',
                ).to.eql(2);
                expect(
                    iD
                        .osmWay({
                            tags: { highway: 'primary_link', oneway: 'no' },
                        })
                        .lanes().metadata.count,
                    'primary lanes',
                ).to.eql(2);
        ...
        describe('seconday', function () {
            it('returns 2 lanes for highway=secondary', function () {
                expect(
                    iD.osmWay({ tags: { highway: 'secondary' } }).lanes()
                        .metadata.count,
                    'secondary lanes',
                ).to.eql(2);
                expect(
                    iD
                        .osmWay({
                            tags: { highway: 'secondary', oneway: 'no' },
                        })
                        .lanes().metadata.count,
                    'secondary lanes',
                ).to.eql(2);
            ...
            it('returns 2 lane for highway=secondary_link', function () {
                expect(
                    iD.osmWay({ tags: { highway: 'secondary_link' } }).lanes()
                        .metadata.count,
                ...
                expect(
                    iD
                        .osmWay({
                            tags: { highway: 'secondary_link', oneway: 'no' },
                        })
                        .lanes().metadata.count,
                    'secondary_link lanes',
                ).to.eql(2);
        ...
        describe('tertiary', function () {
            it('returns 2 lanes for highway=tertiary', function () {
                expect(
                    iD.osmWay({ tags: { highway: 'tertiary' } }).lanes()
                        .metadata.count,
                    'tertiary lanes',
                ).to.eql(2);
                expect(
                    iD
                        .osmWay({ tags: { highway: 'tertiary', oneway: 'no' } })
                        .lanes().metadata.count,
                    'tertiary lanes',
                ).to.eql(2);
            });
            ...
            it('returns 2 lane for highway=tertiary_link', function () {
                expect(
                    iD.osmWay({ tags: { highway: 'tertiary_link' } }).lanes()
                        .metadata.count,
                    'tertiary_link lanes',
                ).to.eql(2);
                expect(
                    iD
                        .osmWay({
                            tags: { highway: 'tertiary_link', oneway: 'no' },
                        })
                        .lanes().metadata.count,
                    'tertiary_link lanes',
                ).to.eql(2);
        ...
        describe('residential', function () {
            it('returns 2 lanes for highway=residential', function () {
                expect(
                    iD.osmWay({ tags: { highway: 'residential' } }).lanes()
                        .metadata.count,
                    'residential lanes',
                ).to.eql(2);
                expect(
        ...
        describe('service', function () {
            it('returns 2 lanes for highway=service', function () {
                expect(
                    iD.osmWay({ tags: { highway: 'service' } }).lanes().metadata
                        .count,
                    'service lanes',
                ).to.eql(2);
                expect(
                    iD
                        .osmWay({ tags: { highway: 'service', oneway: 'no' } })
                        .lanes().metadata.count,
                    'service lanes',
                ).to.eql(2);
            });
            ...
            it('returns 1 lane for highway=service and oneway=yes', function () {
                expect(
                    iD
                        .osmWay({ tags: { highway: 'service', oneway: 'yes' } })
                        .lanes().metadata.count,
                    'service lanes',
                ).to.eql(1);
            });
        ...
        describe('track', function () {
            it('returns 2 lanes for highway=track', function () {
                expect(
                    iD.osmWay({ tags: { highway: 'track' } }).lanes().metadata
                        .count,
                    'track lanes',
                ).to.eql(2);
                expect(
                    iD
                        .osmWay({ tags: { highway: 'track', oneway: 'no' } })
                        .lanes().metadata.count,
                    'track lanes',
                ).to.eql(2);
            });
            ...
            it('returns 1 lane for highway=track and oneway=yes', function () {
                expect(
                    iD
                        .osmWay({ tags: { highway: 'track', oneway: 'yes' } })
                        .lanes().metadata.count,
                    'track lanes',
                ).to.eql(1);
            });
        ...
        describe('path', function () {
            it('returns 2 lanes for highway=path', function () {
                expect(
                    iD.osmWay({ tags: { highway: 'path' } }).lanes().metadata
                        .count,
                    'path lanes',
                ).to.eql(2);
                expect(
                    iD
                        .osmWay({ tags: { highway: 'path', oneway: 'no' } })
                        .lanes().metadata.count,
                    'path lanes',
                ).to.eql(2);
            });
            ...
            it('returns 1 lane for highway=path and oneway=yes', function () {
                expect(
                    iD
                        .osmWay({ tags: { highway: 'path', oneway: 'yes' } })
                        .lanes().metadata.count,
                    'path lanes',
                ).to.eql(1);
            });
    ...
    describe('oneway tags', function () {
        it('returns correctly oneway when tagged as oneway', function () {
            expect(
                iD
                    .osmWay({ tags: { highway: 'residential', oneway: 'yes' } })
                    .lanes().metadata.oneway,
                'residential lanes',
            ).to.be.true;
            expect(
                iD
                    .osmWay({ tags: { highway: 'residential', oneway: 'no' } })
                    .lanes().metadata.oneway,
                'residential lanes',
            ).to.be.false;
        });
    ...
    describe('lane direction', function () {
        ...
        it('returns correctly forward count when oneway=yes', function () {
            expect(
                iD
                    .osmWay({
                        tags: { highway: 'trunk', lanes: 2, oneway: 'yes' },
                    })
                    .lanes().metadata,
                'trunk lanes',
            ).to.include({
        ...
        it('returns correctly backward count the when oneway=-1', function () {
            expect(
                iD
                    .osmWay({
                        tags: { highway: 'primary', lanes: 4, oneway: '-1' },
                    })
                    .lanes().metadata,
                'primary lanes',
            ).to.include({
    ...
    describe('turn lanes', function () {
        ...
        it('returns correctly when multiple values are present in a lane and oneway=no', function () {
            var lanesData = iD
                .osmWay({
                    tags: {
                        ...
                        'lanes:backward': 2,
                        'turn:lanes:forward':
                            'slight_left;reverse;left|slight_left;left;through|through',
            ...
            expect(lanesData.metadata.turnLanes.backward).to.deep.equal([
                ['none'],
                ['through', 'left'],
            ]);
        });
            ...
            var metadata = iD
                .osmWay({
                    tags: {
                        ...
                        'turn:lanes:backward':
                            'none|through|though;slight_right',
                    },
                })
                .lanes().metadata;
        ...
        it.skip('clips when turn lane information is more than lane count', function () {
            ...
            expect(metadata.turnLanes).to.deep.equal([
                ['through'],
                ['through', 'slight_right'],
            ]);
        });
        ...
        it('parses turnLane correctly when lanes:both_ways=1', function () {
            ...
            expect(lanes.metadata.turnLanes.forward).to.deep.equal([
                ['slight_left'],
                ['none'],
                ['none'],
            ]);
            ...
            var lanes = iD
                .osmWay({
                    tags: {
                        ...
                        oneway: 'yes',
                        'turn:lanes':
                            'slight_left||through|through;slight_right|slight_right',
                    },
                })
                .lanes().lanes;
    ...
    describe('bicycle lanes', function () {
        ...
        it('should parse bicycle:lanes:forward/backward correctly', function () {
            var lanes = iD
                .osmWay({
                    tags: {
                        ...
                        'lanes:backward': 3,
                        'turn:lanes:forward':
                            'left;through|left;through|through|right;through|right',
            ...
            var bicyclewayLanesBackward = lanes.lanes.backward.map(
                function (l) {
                    return l.bicycleway;
                },
            );
