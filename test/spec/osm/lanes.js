describe('iD.Lanes', function() {
    ...
    describe.skip('lanes array', function() {
      it('should have correct number of direction elements', function() {
        var lanes = new iD.osmWay({tags: { highway: 'residential', lanes: 5, 'lanes:forward': 2, 'lanes:both_ways': 0, 'lanes:backward': 3 }}).lanes().lanes;
    ...
    describe('maxspeed:lanes', function() {
        ...
        it('should parse correctly', function() {
            var maxspeedLanes = new iD.osmWay({
                tags: {
                    highway: 'residential',
                    lanes: 5,
