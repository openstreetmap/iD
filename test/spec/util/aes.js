describe('iD.utilAes', function () {
    ...
    it('encrypts and decrypts with a custom 16-bit key', function () {
        var key = [
            216, 159, 213, 140, 129, 75, 80, 121, 67, 201, 179, 120, 71, 237,
            185, 42,
        ];
        var text = 'Hello iD!';
    ...
    it('encrypts and decrypts with a custom 24-bit key', function () {
        var key = [
            180, 138, 124, 87, 157, 23, 209, 147, 64, 65, 68, 206, 212, 79, 215,
            114, 37, 18, 159, 94, 168, 68, 177, 202,
        ];
        var text = 'Hello iD!';
    ...
    it('encrypts and decrypts with a custom 32-bit key', function () {
        var key = [
            4, 48, 130, 253, 213, 139, 96, 178, 170, 108, 127, 233, 167, 137,
            181, 41, 145, 62, 251, 9, 82, 159, 103, 198, 63, 200, 158, 104, 188,
            77, 193, 16,
        ];
        var text = 'Hello iD!';
