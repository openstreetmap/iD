describe('iD.rendererFeatures', function () {
    ...
    describe('#gatherStats', function () {
        it('counts features', function () {
            var graph = iD.coreGraph([
                ...
                iD.osmWay({
                    id: 'building_yes',
                    tags: { area: 'yes', amenity: 'school', building: 'yes' },
                    version: 1,
                }),
                iD.osmWay({
                    id: 'boundary',
    ...
    describe('matching', function () {
        var graph = iD.coreGraph([
            ...
            iD.osmWay({
                id: 'building_no',
                tags: { area: 'yes', amenity: 'school', building: 'no' },
                version: 1,
            }),
            iD.osmWay({
                id: 'building_part',
            ...
            iD.osmWay({
                id: 'garage2',
                tags: { area: 'yes', amenity: 'parking', parking: 'sheds' },
                version: 1,
            }),
            iD.osmWay({
                id: 'garage3',
                tags: { area: 'yes', amenity: 'parking', parking: 'carports' },
                version: 1,
            }),
            iD.osmWay({
                id: 'garage4',
            ...
            iD.osmWay({
                id: 'room',
                tags: { area: 'yes', indoor: 'room' },
                version: 1,
            }),
            iD.osmWay({
                id: 'indoor_area',
                tags: { area: 'yes', indoor: 'area' },
                version: 1,
            }),
            iD.osmWay({
                id: 'indoor_bar',
                tags: { area: 'yes', indoor: 'room', amenity: 'bar' },
                version: 1,
            }),
            iD.osmWay({
                id: 'corridor',
                tags: { highway: 'corridor', indoor: 'yes' },
                version: 1,
            }),
            ...
            iD.osmWay({
                id: 'piste_track_combo',
                tags: { 'piste:type': 'alpine', highway: 'track' },
                version: 1,
            }),
            ...
            iD.osmWay({
                id: 'aerialway_platform',
                tags: { public_transport: 'platform', aerialway: 'yes' },
                version: 1,
            }),
            iD.osmWay({
                id: 'old_aerialway_station',
                tags: { area: 'yes', aerialway: 'station' },
                version: 1,
            }),
            ...
            iD.osmWay({
                id: 'forest',
                tags: { area: 'yes', landuse: 'forest' },
                version: 1,
            }),
            iD.osmWay({
                id: 'scrub',
                tags: { area: 'yes', natural: 'scrub' },
                version: 1,
            }),
            iD.osmWay({
                id: 'industrial',
                tags: { area: 'yes', landuse: 'industrial' },
                version: 1,
            }),
            iD.osmWay({
                id: 'parkinglot',
                tags: { area: 'yes', amenity: 'parking', parking: 'surface' },
                version: 1,
            }),
            iD.osmWay({
                id: 'park',
                tags: { area: 'yes', leisure: 'park', parking: 'surface' },
                version: 1,
            }),
            ...
            iD.osmWay({
                id: 'boundary_road',
                tags: { boundary: 'administrative', highway: 'primary' },
                version: 1,
            }),
            ...
            iD.osmWay({
                id: 'bay',
                tags: { area: 'yes', natural: 'bay' },
                version: 1,
            }),
            iD.osmWay({
                id: 'pond',
                tags: { area: 'yes', landuse: 'pond' },
                version: 1,
            }),
            iD.osmWay({
                id: 'basin',
                tags: { area: 'yes', landuse: 'basin' },
                version: 1,
            }),
            iD.osmWay({
                id: 'reservoir',
                tags: { area: 'yes', landuse: 'reservoir' },
                version: 1,
            }),
            iD.osmWay({
                id: 'salt_pond',
                tags: { area: 'yes', landuse: 'salt_pond' },
                version: 1,
            }),
            ...
            iD.osmWay({
                id: 'rail_streetcar',
                tags: { railway: 'tram', highway: 'residential' },
                version: 1,
            }),
            iD.osmWay({
                id: 'rail_trail',
                tags: { railway: 'disused', highway: 'cycleway' },
                version: 1,
            }),
            ...
            // Past/Future
            iD.osmWay({
                id: 'motorway_construction',
                tags: { highway: 'construction', construction: 'motorway' },
                version: 1,
            }),
            iD.osmWay({
                id: 'cycleway_proposed',
                tags: { highway: 'proposed', proposed: 'cycleway' },
                version: 1,
            }),
            iD.osmWay({
                id: 'landuse_construction',
                tags: { area: 'yes', landuse: 'construction' },
                version: 1,
            }),
        ...
        function doMatch(rule, ids) {
            ids.forEach(function (id) {
                ...
                expect(
                    features.getMatches(entity, graph, geometry),
                    'doMatch: ' + id,
        ...
        it('matches building_parts', function () {
            ...
            doMatch('building_parts', ['building_part']);
        ...
        it('matches pistes', function () {
            ...
            doMatch('pistes', ['downhill_piste', 'piste_track_combo']);
        ...
        it('matches aerialways', function () {
            ...
            doMatch('aerialways', ['gondola', 'zip_line']);

            dontMatch('aerialways', [
                'aerialway_platform',
                'old_aerialway_station',
        ...
        it('matches landuse', function () {
            ...
            doMatch('landuse', [
                ...
                'outer',
                'inner1',
                'inner2', // non-interesting members of landuse multipolygon
            ]);
        ...
        it('matches power', function () {
            ...
            doMatch('power', ['point_generator', 'power_line']);
    ...
    describe('hiding', function () {
        ...
        it('hides uninteresting (e.g. untagged or "other") member ways on a hidden multipolygon relation', function () {
            ...
            var inner1 = iD.osmWay({
                id: 'inner1',
                tags: { barrier: 'fence' },
                version: 1,
            });
            var inner2 = iD.osmWay({ id: 'inner2', version: 1 });
            var inner3 = iD.osmWay({
                id: 'inner3',
                tags: { highway: 'residential' },
                version: 1,
            });
            ...
            expect(features.isHidden(outer, graph, outer.geometry(graph))).to.be
                .true; // #2548
            expect(features.isHidden(inner1, graph, inner1.geometry(graph))).to
                .be.true; // #2548
            expect(features.isHidden(inner2, graph, inner2.geometry(graph))).to
                .be.true; // #2548
            expect(features.isHidden(inner3, graph, inner3.geometry(graph))).to
                .be.false; // #2887
        });
