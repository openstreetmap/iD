describe('iD.actionChangePreset', function () {
    ...
    it("preserves the tags of a new preset's addTags", function () {
        ...
        var graph = iD.coreGraph([entity]);
        var oldPreset = iD.presetPreset('old', {
            tags: {
                power: 'plant',
                'plant:source': 'coal',
            },
        ...
        var newPreset = iD.presetPreset('new', {
            tags: {
                power: 'plant',
                'plant:source': 'solar',
    ...
    it('preserves the tags when there is a matching field in the new preset', function () {
        ...
        var newPreset = iD.presetPreset(
            'new',
            { tags: { amenity: 'school' }, fields: ['field'] },
            undefined,
            {
    ...
    it('does not preserve field tags when changing from a subpreset to its parent', function () {
        ...
        var graph = iD.coreGraph([entity]);
        var oldPreset = iD.presetPreset('highway/service/driveway', {
            tags: { highway: 'service', service: 'driveway' },
        });
        var newPreset = iD.presetPreset(
            'highway/service',
            { tags: { highway: 'service' }, fields: ['field'] },
            undefined,
            {
