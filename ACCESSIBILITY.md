...
| 🟠 | Browser zoom keyboard shortcuts | iD overrides the <kbd>Cmd</kbd><kbd>+</kbd> and <kbd>Cmd</kbd><kbd>–</kbd> shortcuts. Firefox's text-only zoom shortcuts are okay | [#7976](https://github.com/openstreetmap/iD/issues/7965) |
